...
public class APRailings : MonoBehaviour 
{
	...
	public class Settings
	{
		...
		public string m_animClimbUp = string.Empty;				// anim name for climb up
		public string m_animClimbRight = string.Empty;			// anim name for climb right
		public string m_animClimbDown = string.Empty;			// anim name for climb down
		public string m_animClimbLeft = string.Empty;			// anim name for climb left
	}
	...
	void UpdateRailings () 
	{
		...
		if(m_isControlling)
		{
			...
			// update velocity
			m_motor.m_velocity.x = APInputJoystick.Update(m_motor.m_velocity.x, oSettings.m_maxSpeed * m_player.m_inputs.m_axisX.GetRawValue(), true, oSettings.m_acceleration, oSettings.m_deceleration, Time.deltaTime);
			m_motor.m_velocity.y = APInputJoystick.Update(m_motor.m_velocity.y, oSettings.m_maxSpeed * m_player.m_inputs.m_axisY.GetRawValue(), true, oSettings.m_acceleration, oSettings.m_deceleration, Time.deltaTime);
	...
	void Takecontrol()
	{
		if(!m_isControlling)
		{
			...
			if(m_player.m_advanced.m_enableSendMessages)
